...
document.addEventListener('DOMContentLoaded', () => {
    ...
    Papa.parse("combined_wine_quality.csv", {
        ...
        complete: function (results) {
            ...
            originalData.red = data.filter(d => d.type === 'red');
            originalData.white = data.filter(d => d.type === 'white');

            let features = Object.keys(originalData.red[0]).filter(key => key !== 'type' && key !== 'quality');
            filterDataByQuality();
